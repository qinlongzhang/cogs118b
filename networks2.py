...
def unet_2D(pretrained_weights = None,input_size = (256,256,3),n_filters = 64,batchnorm = True,dropout = 0.1):
    ...
    # Expansive Path
    u5 = Conv2DTranspose(n_filters * 4, (3, 3), strides = (2, 2), padding = 'same')(c5)
    u5 = concatenate([u5, c3])
    u5 = Dropout(dropout)(u5)
    c5 = conv2d_block(u5, n_filters * 4, kernel_size = 3, batchnorm = batchnorm)
    
    u6 = Conv2DTranspose(n_filters * 2, (3, 3), strides = (2, 2), padding = 'same')(c6)
    u6 = concatenate([u6, c2])
    u6 = Dropout(dropout)(u6)
    c6 = conv2d_block(u6, n_filters * 2, kernel_size = 3, batchnorm = batchnorm)
    
    u7 = Conv2DTranspose(n_filters * 1, (3, 3), strides = (2, 2), padding = 'same')(c7)
